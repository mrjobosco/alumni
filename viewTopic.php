...
$views->activeRecord()->relate(['topic_id'  =>  Input::get('id')]);
...
$topics->activeRecord()->relate(['id'    =>  Input::get('id')]);

$all_threads = $topics->getThread();
...
if (Input::exists()) {
    if ($user->isLoggedIn()) {
        ...
        $threads = new Threads();
        $threads->activeRecord()->create([

            'topic_id' => Input::get('id'),
            'creator_id' => $user->activeRecord()->getId(),
            'comment' => Input::get('post'),
            'create_time' => time(),
            'votes'         =>  0

        ]);

        Session::flash('Threads', "You have successfully Created a Thread");
        Redirect::to('viewtopic.php?id=' . Input::get('id'));
            ...
            ';
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="view-question">
                                <?php
                                $creator = new User($topics->activeRecord()->data()->creator_id);
                                echo '<strong>Topic: '.$topics->activeRecord()->data()->name.'</strong>';

                                ?>
                                <div>
                                 Threads:   <?= $topics->getThreadCount($topics->activeRecord()->getId())?>
                                    View:   <?= $count?>
                            ...
                            <div class="description">
                                <?= $topics->activeRecord()->data()->description?>
                            </div>
                            ...
                            <div class="feedback">
                                ...
                                foreach($all_threads as $post) {
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-12">
                                            <span
                                                class="pull-left"><strong>Posted By:</strong><span onmouseleave="name_out()" onmouseover="names_hover(this.id)" id="<?= $u->activeRecord()->data()->id ?>"><?= $u->activeRecord()->data()->username ?></span>
                                        ...
                                        <div class="col-md-10 col-md-offset-2">
                                            <div class="reply">
                                                ...
                                                foreach ($all_replies as $r){
                                                    ...
                                                    <span
                                                        class="pull-left"><strong>Posted By:</strong><span onmouseleave="name_out()" onmouseover="names_hover(this.id)" id="<?= $ru->activeRecord()->data()->id ?>"><?= $ru->activeRecord()->data()->username ?></span>
                            ...
                            <div class="answer-the-question">
                                ...
                                <form action="" method="post">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" placeholder="" name="post" rows="10"></textarea>
                                    </div>
                                    <div>

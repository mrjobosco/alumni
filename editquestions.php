...
Html::start("Alumni System | Edit Question");
...
if (Input::exists()){
    ...
    $topic->activeRecord()->update([
        'question'  =>  Input::get('name'),
        'description'   =>  Input::get('description')
    ]);

    Session::flash('Home', 'You have successfully updated this Question');
                        ...
                        <div class="box-body">
                            <form action="" method="post">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" class="form-control" value="<?= $topic->activeRecord()->data()->question?>">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <input type="submit" class="btn btn-info" value="Update Question">
                                </div>
                            </form>
                        </div>

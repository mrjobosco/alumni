...
Html::start("Alumni System | Manage Users");
                        ...
                        <div class="box-body">
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    $users = new User();
                                    $i = 1;
                                    foreach ($users->activeRecord()->read()->results() as $result) {
                                        ?>
                                        <tr>
                                        ...
                                        <td><a href="edituser.php?id=<?= $result->id?>" class="btn bg-purple-gradient">Edit User</a> </td>
                                        <td> <button onclick="deleteUser(<?= $result->id?>)" class="btn bg-red-gradient">Delete User</button></td>
                                </tr>

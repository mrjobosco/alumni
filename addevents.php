...
if(Input::exists()){
    ...
    Session::flash('Home', "Your have successfully posted an Event");
                    ...
                    <form action="" method="post">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    <input class="form-control" required name="event" placeholder="Event Information">
                                </div>
                                <div class="clearfix"></div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="col-md-12">
                                    <input class="btn bg-purple-gradient" type="submit" value="Post Event">
                                </div>
                            </div>
